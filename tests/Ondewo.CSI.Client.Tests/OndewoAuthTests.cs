...
namespace Ondewo.Csi.Client.Tests
{
    ...
    public class OndewoAuthTests
    {
        ...
        public async Task CreateBearerInterceptorAppendsTheTokenToCallMetadata()
        {
            ...
            await interceptor(new AuthInterceptorContext("https://grpc-csi.ondewo.com", "GetS2sPipeline"), metadata);
        ...
        {
            AsyncAuthInterceptor interceptor = OndewoAuth.CreateBearerInterceptor(Token);
            var context = new AuthInterceptorContext("https://grpc-csi.ondewo.com", "GetS2sPipeline");
